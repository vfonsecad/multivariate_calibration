...
class weighted_mcesimpls_sklearn(BaseEstimator, RegressorMixin):
    ...
    def fit(self, xx, yy):
        ...
        if robpca_check:
            ...
            h_difference = P_od_flag.sum()-P_old.sum()
            
            P_old = np.diag(P_od_flag*1)
            
            P = np.diag(P_resd_flag*1)
        ...
        self.sample_weights2 = P_old
        self.h_difference = h_difference
...
class weighted_mcesimpls(object):
    ...
    def train(self, iters=30, current_v0=None, factor_sigma=1, robpca_check = False, robpca_h = 30):
        ...
        weighted_mcesimpls_Output = {'BPLS': weighted_mcesimpls_coeff,
                         ...
                         'sample_weights2': weighted_mcesimpls_trainObject.sample_weights2,
                         'factor_sigma': factor_sigma,
                         'rsimpls' : robpca_check,
                         'h_difference': weighted_mcesimpls_trainObject.h_difference
